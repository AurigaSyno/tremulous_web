# Tremulous Web
Tremulous web client, game server and master server. This is for the web port which can be found at https://www.tremulous.online
...
Master server for `tremulous.online`. Since this is websocket based, webclients need their own master server.

## tremulous_assets
Stores all the PK3 assets used by `tremulous_game_server` and `tremulous_content_server`.